...
MANIFEST_FILES=(
  ".gitignore"
  ".npmrc"
  "app/api/tasks/update-overdue/route.ts"
  ...
  "components/crm/mark-finished-dialog.tsx"
  "components/crm/meeting-modal.tsx"
  "components/crm/meetings-calendar-view.tsx"
  "components/crm/meetings-table.tsx"
  "components/crm/pipeline-board.tsx"
  "components/crm/reports-dashboard.tsx"
  "components/crm/task-detail.tsx"
  "components/crm/tasks-page.tsx"
  "components/crm/timeline-view.tsx"
  ...
  "scripts/026_lead_excluded_from_reports.sql"
